...
public class student {
    ...
    public static void main(String[] args) {
        student s1 = new student("Giri", 21, 'A','F', 77,79,89);
        student s2 = new student("Hari", 29, 'B','F', 0,56,65);
        student s3 = new student("Brahmam", 21, 'A','M', 0,89,66);
        student s4 = new student("Siri", 24, 'B','F', 79,98,87);
